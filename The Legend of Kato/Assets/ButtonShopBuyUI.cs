...
public class ButtonShopBuyUI : MonoBehaviour
{
    ...
    private void Start()
    {
        up = FindObjectOfType<SpriteTranslator>().GetSprite(up, 11);
        down = FindObjectOfType<SpriteTranslator>().GetSprite(down, 12);
